---
title: "<span style='color: white;'>Identifying potential priority local authorities in England for intergenerational care facilities</span>"
...
**You can read this policy briefing [here](Priority_LAs_for_intergenerational_care_facilities_BRIEFING.pdf){target="_blank"}**.
...
![](Outputs/choropleth_raw_variables.png)
...
![](Outputs/choropleth_raw_features.png)
...
![](Outputs/correlation_matrix_heatmap.png)
...
![](Outputs/zscore_scattermatrix.png)
...
![](Outputs/distance_from_cluster_centres.png)
...
![](Outputs/cluster_centres_by_feature.png)
...
![](Outputs/map_cluster_results.png)
...
![](Outputs/map_London_cluster.png)
